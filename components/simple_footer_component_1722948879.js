...
*/
Vue.component("simple_footer_component_1722948879", {
    template: `
                ...
                <div id="footer-content" class="text-center">
                    <div class="flex">
                        <a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-6 text-3xl font-bold text-white hover:text-pink-200 transition-colors duration-300">
                            ...
                            BlockChainInsight: Discover Blockchain Data
                        </a>
                    </div>
                </div>
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-lg text-center text-white text-opacity-80 hover:text-opacity-100 transition-opacity duration-300">
                        Stay ahead of the curve with BlockChainInsight. Our powerful platform lets you explore the latest blockchain information, trends, and updates. Whether you're a developer, researcher, or enthusiast, we've got you covered.
                    </div>
                </div>
            </div>
        </footer> 
